...
bc:sendEvent("value_changed",_c)end}ac.__index=ac;return setmetatable(ac,cb)end end;aa["libraries"]={}
...
dc:setForeground(_d:getTheme(db.."Text"))end end}return cc end end;return bb end;return aa["main"]()